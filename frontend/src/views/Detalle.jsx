...
const Detalle = () => {
    ...
    const handleEnviarCorreo = (e) => {
        e.preventDefault();
        toast.success(`✉️ Mensaje enviado con éxito`, {
            icon: "🚀"
        });
        setShowModal(false);
        setMensaje("");
                ...
                <div className="row g-0">
                    ...
                    <div className="col-md-6 ps-md-5">
                        <div className="card-body p-0 text-light">
                            ...
                            <h1 className="fw-bold mb-2">{producto.nombre || producto.name}</h1>

                            <span className="badge bg-transparent border border-secondary text-light fw-normal mb-4">
                                {producto.condicion || producto.condition}
                            </span>
                            ...
                            <div className="p-3 rounded mb-4" style={{ backgroundColor: 'rgba(255, 255, 255, 0.05)' }}>
                                <p className="text-light opacity-75" style={{ whiteSpace: 'pre-line', lineHeight: '1.6' }}>
                                    {producto.descripcion || getDescription(producto.condicion || producto.condition)}
                                </p>
                            </div>

                            <div className="mb-4">
                                <p className="text-secondary mb-1">Precio:</p>
                                <h2 className="fw-bold text-primary">${Number(producto.precio || producto.price).toLocaleString("es-CL")}</h2>
                            </div>
                        ...
                        <form onSubmit={handleEnviarCorreo}>
                            <div className="mb-3">
                                ...
                                <input
                                    ...
                                    value={`Consulta por: ${producto.nombre || producto.name}`}
                                    readOnly
                                />
                            </div>
